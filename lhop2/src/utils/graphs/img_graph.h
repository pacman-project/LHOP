...
public:
    ...
    node* make_grid_node(node* n); // unused
...
template<class I> irectangle2 get_nodes_bounding_rectangle(I begin, I end)
{
    irectangle2 rect;

    for (; begin != end; ++begin) {
        img_node_data* nd = (img_node_data*)(*begin)->data;
        rect.eat(nd->x, nd->y);
    }
    return rect;
}
